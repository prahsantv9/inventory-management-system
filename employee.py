...
class employeeclass:
    def __init__(self,root):
        ...
        txt_empid=Entry(self.root,textvariable=self.var_emp_id,font=("gaudy old style",15),bg="lightyellow").place(x=150,y=150,width=180)
        ...
        txt_contact=Entry(self.root,textvariable=self.var_emp_contact,font=("gaudy old style",15),bg="lightyellow").place(x=850,y=150,width=180)
        ...
        lbl_ytype=Label(self.root,text="User type",font=("goudy old style",15),bg="white").place(x=700,y=230)
        ...
        txt_utype=Entry(self.root,textvariable=self.var_emp_utype,font=("goudy old style",15),bg="lightyellow").place(x=850,y=230,width=180)
        ...
        lbl_salary=Label(self.root,text="Salary",font=("goudy old style",15),fg="black",bg="white").place(x=500,y=270)
